...
class OrderItemNameTest {
    ...
    void create() {
        ...
        /* when & then */
        assertThatCode(() -> new OrderItemName(name))
    ...
    void createFailWithNullOrEmpty(String name) {
        ...
        /* when & then */
        assertThatThrownBy(() -> new OrderItemName(name))
    ...
    void equalsAndHashCode() {
        /* given */
        OrderItemName origin = new OrderItemName("마싯는 소주");
        OrderItemName same = new OrderItemName("마싯는 소주");
        OrderItemName different = new OrderItemName("맛없는 소주");
